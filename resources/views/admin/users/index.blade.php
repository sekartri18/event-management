                                ...
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-{{ $user->role->name === 'admin' ? 'red' : ($user->role->name === 'organizer' ? 'indigo' : 'green') }}-100 text-{{ $user->role->name === 'admin' ? 'red' : ($user->role->name === 'organizer' ? 'indigo' : 'green') }}-800">
